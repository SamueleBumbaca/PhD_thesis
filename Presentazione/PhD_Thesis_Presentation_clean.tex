...
% Slide 9: Statistical Methods Comparison: Introduction
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{exampleblock}{Synthetic Dataset:}
                \begin{itemize}
                    \item \textbf{54 observations} (6×9 grid)
                    \item \textbf{3 treatments}: Control (0 t/ha), Reference (0.5 t/ha), Test (1.0 t/ha)
                    \item \textbf{3 blocks} (18 plots each)
                    \item \textbf{Irregular environmental pattern} matching presentation slide design
                    \item \textbf{Environmental zones}: Low (-1.5 t/ha), Medium (0 t/ha), High (+1.5 t/ha)
                \end{itemize}
            \end{exampleblock}
        \end{column}
...
% Slide 10: Statistical Methods Comparison: The Field Trial
\begin{frame}
    \frametitle{Statistical Methods Comparison: The Field Trial Design}
    
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../integrated_rcbd_spats_comparison_irregular.png}
    \end{center}
...
% Slide 11: Statistical Methods Comparison: Results
\begin{frame}
        ...
        \begin{column}{0.5\textwidth}
            \begin{block}{\small Model Performance (Mean Absolute Errors):}
                \begin{table}[h]
                    ...
                    \begin{tabular}{lcc}
                        \hline
                        \textbf{Model} & \textbf{Treatment Error} & \textbf{Environmental Error} \\
                        \hline
                        RCBD Model & 0.1384 & 0.6277 \\
                        SpATS Spatial & \textcolor{green}{\textbf{0.0360}} & \textcolor{green}{\textbf{0.4488}} \\
                        \hline
                    \end{tabular}
                \end{table}
            \end{block}
            ...
            \begin{exampleblock}{\small Treatment Effect Estimation:}
                \begin{table}[h]
                    ...
                    \begin{tabular}{lccc}
                        ...
                        Reference & 0.500 & 0.399 & \textcolor{green}{\textbf{0.452}} \\
                        Test & 1.000 & 0.686 & \textcolor{green}{\textbf{0.940}} \\
                        \hline
                    \end{tabular}
                \end{table}
            \end{exampleblock}
...
% Slide 12: Georeferencing EPPO standard assessments
\begin{frame}
