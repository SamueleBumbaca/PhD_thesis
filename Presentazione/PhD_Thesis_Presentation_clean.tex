...
\setbeamertemplate{title page}{
    \begin{picture}(0,0)
        \put(25,-220){\includegraphics[width=0.8\paperwidth]{Presentazione/Imgs/Loghi.png}}
    \end{picture}
    \vfill
    \centering
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Presentazione/Imgs/integrated_rcbd_spats_comparison_irregular.png}
    \end{center}
...
\begin{frame}
    ...
    \begin{center}
        \begin{tikzpicture}[
            ...
            \node[below] at (visual_group.south) {\scriptsize \textbf{Visual assessments (counts, ranks and scores)}};
            ...
            \node[above] at (continuous_group.north west) {\scriptsize \textbf{Measurments}};
            ...
            % Output Block
            \node[block, fill=green!20, text width=4.5cm] (output) at (5.8,-2.8) {
