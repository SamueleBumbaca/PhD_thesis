# Test the new ggplot legend for wheat spikes
...
p <- ggplot() +
  ...
  xlim(0, 45) + ylim(0, 30) +
  theme_minimal() +
  labs(title = "Test Plot with ggplot Wheat Spike Legend",
...
# Save the test plot
ggsave("test_ggplot_legend.png", plot = p, width = 12, height = 8, dpi = 300, bg = "white")

print("Test plot with ggplot legend saved as test_ggplot_legend.png")
