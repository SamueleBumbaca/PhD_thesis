...
their accuracy and adaptability \cite{salinas_ruiz_generalized_2023}. Computer vision is a subfield of 
ML that focuses on enabling machines to interpret and analyze visual information. In 
...
within PP1/333 trials significantly enhances data acquisition by enabling continuous monitoring 
...
disease symptoms, and pest damage \cite{kamilaris_deep_2018}. Convolutional Neural Networks (CNNs) 
and related architectures, including ResNet and U-Net, have shown high efficacy in analyzing 
complex agricultural images \cite{pandian_j_improved_2022, ronneberger_u-net_2015}. Moreover, combining computer 
...
\cite{koldasbayeva_challenges_2024}. This integrated approach maximizes the utility of both 
spatial and temporal data, facilitating more robust and accurate assessments while 
minimizing human error and labor requirements \cite{goodfellow_deep_2016}.

Having representative big datasets and computing power are significant challenges in deep learning. 
...
frequently involves manual annotation, which introduces human bias and can be extremely labor-intensive. 
...
Computing power presents another substantial bottleneck in deep learning research and application. 
Training state-of-the-art neural networks requires massive computational resources, creating a significant 
barrier to entry for researchers and organizations with limited budgets or for applications where
edge computing is needed, creating also carbon-foot-print concernings \cite{patterson2021carbon}.
