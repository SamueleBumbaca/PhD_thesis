...
\begin{figure}[H]
 ...
 \begin{adjustwidth}{-\extralength}{0cm}
  \centering
  \subfloat[\centering]{\includegraphics[width=15cm]{Plots/r2_ap_vs_dataset_size_yolov5.pdf}}\\
  \subfloat[\centering]{\includegraphics[width=15cm]{Plots/r2_ap_vs_dataset_size_yolov8.pdf}}\\
  \subfloat[\centering]{\includegraphics[width=15cm]{Plots/r2_ap_vs_dataset_size_yolo11.pdf}}\\
  \subfloat[\centering]{\includegraphics[width=15cm]{Plots/r2_ap_vs_dataset_size_rtdetr.pdf}}\\
   
\end{adjustwidth}
 \caption{Relationship %MDPI: legend is over a part of the curves. Please check whether it affects reading. %Authors: Legend position checked and does not affect reading, curves under the legends are negligible
